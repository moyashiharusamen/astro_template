...
各階層における index ファイルを指定する場合、「index.html」 「index.php」「index.cgi」 を直接指定せずに 「/」にて指定する
...
HTML 内にて style 要素での書き込みは行わないでください
...
HTML 内にて script 要素での書き込みは行わないでください
